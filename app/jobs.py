...
def send_pending_requester_test_reminders():
    job_name = 'send_pending_requester_test_reminders'
    ...
    def _job():
        ...
        _request_or_raise(
            job_name,
            'GET',
            f'{BASE_URL}/software_request/admin/email-pending-requester-tests',
            params=params,
            timeout=90,
        )
...
def send_pending_requester_test_line_reminders():
    job_name = 'send_pending_requester_test_line_reminders'
    ...
    def _job():
        ...
        _request_or_raise(
            job_name,
            'GET',
            f'{BASE_URL}/software_request/admin/line-pending-requester-tests',
            params=params,
            timeout=90,
        )
...
scheduler.add_job(send_software_request_summary_report,
                  ...
                  minute='00',
                  timezone='Asia/Bangkok')
scheduler.add_job(send_pending_requester_test_reminders,
                  'cron', day_of_week='mon',
                  hour='9',
                  minute='00',
                  timezone='Asia/Bangkok')
scheduler.add_job(send_pending_requester_test_line_reminders,
                  'cron', day_of_week='mon',
                  hour='9',
                  minute='00',
                  timezone='Asia/Bangkok')
