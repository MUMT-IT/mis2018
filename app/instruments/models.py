...
class InstrumentsBooking(db.Model):
    ...
    location_id = db.Column('location_id', db.ForeignKey('scheduler_room_resources.id'))
    location = db.relationship(RoomResource, backref=db.backref('instruments_location', lazy='dynamic'))
