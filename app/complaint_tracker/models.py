...
class ComplaintRepairApproval(db.Model):
    ...
    mhesi_no_date = db.Column('mhesi_no_date', db.DateTime(timezone=True), info={'label': 'วันที่ออกเลขอว.'})
    ...
    receipt_date = db.Column('receipt_date', db.DateTime(timezone=True), info={'label': 'วันที่'})
